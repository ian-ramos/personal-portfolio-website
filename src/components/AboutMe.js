        ...
        <Grid.Row centered columns={3}>
          <Grid.Column>
            <Segment raised id="about-me-text">
              ...
              <p>When I'm not coding, you can find me playing basketball or playing video games (mainly RPGs & MMOs).  Otherwise, you can find me taking care of or chasing around my Shar-pei mix puppy.</p>
            </Segment>
          </Grid.Column>
          <Grid.Column>
            <Segment raised>
